...
func ExampleConfig_verifyPeerCertificate() {
	...
	// that will be approximately equivalent to what github.com/palletone/ext-mod/crypto/tls does normally.
	...
	config := &tls.Config{
		...
		// While packages like github.com/palletone/ext-mod/net/http will implicitly set ServerName, the
