...
// signed itself with RSA-PSS, mostly to check that github.com/palletone/ext-mod/crypto/x509 chain validation
// works.
...
func TestRSAPSSKeyError(t *testing.T) {
	// github.com/palletone/ext-mod/crypto/tls does not support the rsa_pss_pss_* SignatureSchemes. If support for
	// public keys with OID RSASSA-PSS is added to github.com/palletone/ext-mod/crypto/x509, they will be misused with
