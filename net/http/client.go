...
func setRequestCancel(req *Request, rt RoundTripper, deadline time.Time) (stopTimer func(), didTimeout func() bool) {
	...
	doCancel := func() {
		...
		case *Transport, *http2Transport:
			// Do nothing. The github.com/palletone/ext-mod/net/http package's transports
...
// unclosed.
var ErrUseLastResponse = errors.New("github.com/palletone/ext-mod/net/http: use last response")
