...
import (
	...
	"log"
	"net"
	. "github.com/palletone/ext-mod/net/http"
	"github.com/palletone/ext-mod/net/http/httptest"
	"github.com/palletone/ext-mod/net/http/httputil"
	"net/url"
	"os"
	"reflect"
	"runtime"
...
// transport_test.go (for HTTP/1) or x/github.com/palletone/ext-mod/net/http2/transport_test.go
// (for HTTP/2).
...
func testWriteHeaderAfterWrite(t *testing.T, h2, hijack bool) {
	...
	wantLog := "http: superfluous response.WriteHeader call from github.com/palletone/ext-mod/net/http_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	if hijack {
		wantLog = "http: response.WriteHeader on hijacked connection from github.com/palletone/ext-mod/net/http_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	}
