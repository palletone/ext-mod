...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"github.com/palletone/ext-mod/net/http.(*Client).Get":          true,
		"github.com/palletone/ext-mod/net/http.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"github.com/palletone/ext-mod/net/http.http2Server":           false,
		"github.com/palletone/ext-mod/net/http.(*Server).Serve":       false,
		"github.com/palletone/ext-mod/net/http.(*ServeMux).ServeHTTP": false,
		"github.com/palletone/ext-mod/net/http.DefaultServeMux":       false,
	}
