...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/palletone/ext-mod/net/http_test.interestingGoroutines") ||
...
func goroutineLeaked() bool {
	...
	fmt.Fprintf(os.Stderr, "Too many goroutines running after github.com/palletone/ext-mod/net/http test(s).\n")
...
func afterTest(t testing.TB) {
	...
	badSubstring := map[string]string{
		...
		"created by github.com/palletone/ext-mod/net/http/httptest.(*Server).Start": "an httptest.Server",
