...
import (
	...
	"github.com/palletone/ext-mod/net/http/internal"
	"net/url"
	"os"
	"os/exec"
	"reflect"
...
// response, the github.com/palletone/ext-mod/net/http package adds a "Content-Length: 0" response
// header.
...
func TestHTTP10ConnectionHeader(t *testing.T) {
	...
	// github.com/palletone/ext-mod/net/http uses HTTP/1.1 for requests, so write requests manually
	tests := []struct {
