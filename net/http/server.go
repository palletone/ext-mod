...
var (
	...
	// anything in the github.com/palletone/ext-mod/net/http package. Callers should not
...
// is preferred:
//    https://golang.org/pkg/github.com/palletone/ext-mod/net/http/#ResponseWriter
//    https://golang.org/pkg/github.com/palletone/ext-mod/net/http/#example_ResponseWriter_trailers
...
// relevantCaller searches the call stack for the first function outside of github.com/palletone/ext-mod/net/http.
...
func relevantCaller() runtime.Frame {
	...
	for {
		...
		if !strings.HasPrefix(frame.Function, "github.com/palletone/ext-mod/net/http.") {
			return frame
		}
		if !more {
			break
...
var ErrAbortHandler = errors.New("github.com/palletone/ext-mod/net/http: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.isSet() {
		panic("github.com/palletone/ext-mod/net/http: Hijack called after ServeHTTP finished")
	}
	if w.wroteHeader {
		w.cw.flush()
	}
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.isSet() {
		panic("github.com/palletone/ext-mod/net/http: CloseNotify called after ServeHTTP finished")
	}
...
// recognized by x/github.com/palletone/ext-mod/net/http2 to pass down a context; the TLSNextProto
